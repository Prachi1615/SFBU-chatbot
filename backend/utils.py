...
answer_to_human_str = """
    If you are not sure about the answer, you should return with No, I don't know an answer to that question and ask the user to get help from a human officer or submit an inquiry to https: // www.sfbu.edu/contact-us.
